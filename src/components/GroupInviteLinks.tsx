...
interface SecretRowProps {
  ...
  onCopy: () => void
  /**
   * 옮겨 적는 값(참여 코드)은 등폭 서체로 — 본문 서체에서는 `I/l`·`O/0`·대소문자가 헷갈린다.
   * joinKey는 **대소문자를 구분해 매칭**하므로(CHMO-285) 한 글자만 잘못 읽어도 합류가 막힌다.
   * 정확한 전사가 브랜드 일관성보다 중한 자리라 어드민 `font-admin`과 같은 예외를 둔다
