...
interface SignupConsentFormProps {
  submitting: boolean
  /** 제출 실패 메시지 — CTA 위에 표시(체크 상태는 보존된 채 재시도) */
  error: string | null
...
/**
 * 가입 동의 폼 (정본 docs/legal/app-copy.md §1~§4) — 01-A 가입 동의(CHMO-479)와 01-C 소셜
 * 콜백의 가입 분기(CHMO-602)가 같은 폼을 그린다: 동의를 받는 시점이 다를 뿐(01-A는 로그인 후
 * 게이트, 01-C는 exchange=가입 전) 항목·문구·제약이 같아야 기록이 증빙이 된다.
 *
